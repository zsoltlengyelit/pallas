...
public class Form<T> implements Map<String, String> {
     ...
     */
    public static <T> Form<T> form(final Class<T> clazz) {
     ...
     * Instantiates a new form that wraps the specified class.
     */
    public static <T> Form<T> form(final String name, final Class<T> clazz) {
     ...
     * Instantiates a new form that wraps the specified class.
     */
    public static <T> Form<T> form(final String name, final Class<T> clazz, final Class<?> group) {
     ...
     * Instantiates a new form that wraps the specified class.
     */
    public static <T> Form<T> form(final Class<T> clazz, final Class<?> group) {
    ...
    public Form<T> bind(final Map<String, String> data, final String... allowedFields) {
        ...
        if (result.hasErrors() || result.getGlobalErrorCount() > 0) {
            ...
            return new Form(rootName, backedType, data, errors, Optional.absent(), groups);
        } else {
            ...
            return new Form(rootName, backedType, new HashMap<String, String>(data), new HashMap<String, List<ValidationError>>(errors), Optional.of((T) result.getTarget()),
                    groups);
        }
    }
