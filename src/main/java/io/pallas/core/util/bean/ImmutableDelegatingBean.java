...
/**
 * An immutable implementation of {@link Bean} that allows you to build general purpose beans by delegating function to an existing managed bean (likely a producer method). This is
 * useful for wiring non-specific producer methods to produce instances of an object that matches the discovered criteria of the injected field. For example, a producer that
 * creates a new instance of an object matching the type of the field.
 *
 * <pre>
 *     @Produces
 *     @SomeQualifier
 ...
 * </pre>
 *
 * @see io.pallas.core.cdi.PallasCdiExtension
 *
...
public class ImmutableDelegatingBean<T> implements Bean<T> {
	...
	public ImmutableDelegatingBean(final Bean<Object> delegate, final BeanBuilder<T> beanBuilder) {
