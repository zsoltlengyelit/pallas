...
public class LinkBuilder {
	...
	@Inject
	public LinkBuilder(final HttpRequest request, final HttpResponse response, final ControllerNameResolver controllerNameResolver, final WebApplication application,
	...
	public String of(final String cbase) {
		...
		final String contextPath = request.getPath();

		return contextPath + cbase;
	}
