...
public class PallasCdiExtension implements Extension {
	...
	public void processViewModuleProducerInverted(@Observes final ProcessProducerMethod<Application, io.pallas.core.module.Module> event) {
	...
	public List<StartupBean> getStartupBeans() {
